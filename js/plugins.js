    ...
    !(function() {
        ...
        (s.prototype.isVideo = function(e, t) {
            ...
            if (
                ((s = this.s.dynamic ?
                    ...
                    this.$items.eq(t).attr("data-html")), !e)
            )
                return s ?
                    { html5: !0 } :
                    (console.error(
            ...
            if (
                (this.s.dynamic ?
                    ...
                    ((l = i.attr("data-sub-html")),
                        ...
                        !l &&
                        (l = i.attr("title") || i.find("img").first().attr("alt"))), !s)
            )
                if (null != l) {
        ...
        (s.prototype.loadContent = function(t, s, i) {
            ...
            if (g.s.dynamic) {
                ...
                (r = g.$items.eq(t).attr("data-srcset")),
                (a = g.$items.eq(t).attr("data-sizes"));
            }
            var c = !1;
            g.s.dynamic ?
            ...
            g.$slide
                ...
                m && m.html5 && !h && g.$slide.eq(t).addClass("lg-complete"), !0 === s &&
        ...
        (s.prototype.touchMove = function(t, s) {
            ...
            Math.abs(i) > 15 &&
                (this.$outer.addClass("lg-dragging"),
                    ...
                    this.setTranslate(
                        e(".lg-prev-slide"), -this.$slide.eq(this.index).width() + i,
                        0
                    ),
                    this.setTranslate(
                        e(".lg-next-slide"),
        ...
        (s.prototype.enableDrag = function() {
            ...
            t.s.enableDrag &&
                t.doCss() &&
                (t.$outer.on("mousedown.lg", function(i) {
        ...
        (d.prototype.zoomDrag = function() {
            ...
            b.core.$slide.on("mousedown.lg.zoom", function(d) {
                ...
                a(window).on("mouseup.lg.zoom", function(a) {
                    e &&
                        ((e = !1),
                            b.core.$outer.removeClass("lg-zoom-dragging"), !f ||
                            (c.x === d.x && c.y === d.y) ||
...
function() {
    ...
    (function(a) {
        ...
        function d(a, b) {
            c(a);
            for (
                var d = a.parentNode.querySelectorAll(b), e = 0, f = d.length; f > e; e++
            )
                if (d[e] === a) return !0;
            return !1;
        }
        ...
        var f,
            g = (function() {
                ...
                for (
                    var b = ["webkit", "moz", "ms", "o"], c = 0, d = b.length; d > c; c++
                ) {
                    var e = b[c],
                        f = e + "MatchesSelector";
                    if (a[f]) return f;
            ...
            for (var e = [], f = 0, g = a.length; g > f; f++) {
                ...
                if (d.isElement(h))
                    if (b) {
                        c(h, b) && e.push(h);
                        for (
                            var i = h.querySelectorAll(b), j = 0, k = i.length; k > j; j++
                        )
                            e.push(i[j]);
                    } else e.push(h);
            }
    ...
    (function(e, t) {
        ...
        (s.prototype.getImages = function() {
            ...
            for (var e = 0, t = this.elements.length; t > e; e++) {
                ...
                if (i && (1 === i || 9 === i || 11 === i))
                    for (
                        var r = n.querySelectorAll("img"), o = 0, s = r.length; s > o; o++
                    ) {
                        var f = r[o];
                        this.addImage(f);
                    }
    ...
    return (
        ...
        (i.prototype.itemDragEnd = function(b) {
            var c,
                d = this.getItem(b);
            if (
                (d && ((c = d.didDrag), d.dragStop()), !d || (!c && !d.needsPositioning))
            )
                    ...
                    return (
                        ...
                        this.each(function() {
                            ...
                            r.forEach(function(e) {
                                ...
                                "undefined" != typeof u &&
                                (i.addClass("share-affix"), -1 != u.indexOf("right") ?
                                    (i.css("left", "auto"),
                                        i.css("right", "0px"), -1 != u.indexOf("center") && i.css("top", "40%")) :
                                    -1 != u.indexOf("left center") && i.css("top", "40%"), -1 != u.indexOf("bottom") &&
                                    (i.css("bottom", "0px"),
                                        i.css("top", "auto"), -1 != u.indexOf("center") && i.css("left", "40%"))),
...
!(function t(e, n, r) {
    ...
    for (
        var i = "function" == typeof require && require, l = 0; l < r.length; l++
    )
        o(r[l]);
    return o;
})({
            ...
            function r(t, e) {
                ...
                function r(t) {
                    ...
                    return (
                        ...
                        e !== e && n !== n && ((e = 0), (n = t.wheelDelta)), [e, n]
                    );
                }
            ...
            e.exports = function(t) {
                ...
                t.contains(e.scrollbarXRail) ||
                    ...
                    ((n = l.queryChildren(t, ".ps-scrollbar-y-rail")),
                        ...
                        l.appendTo(e.scrollbarYRail, t)), !e.settings.suppressScrollX &&
                    ...
                    (e.scrollbarXActive = !1), !e.settings.suppressScrollY &&
...
!(function(e) {
            ...
            (o = function(t, i) {
                ...
                return (
                    ...
                    (a.initialize = function(t, n) {
                        (a.params = e.extend({ color: "white", minSize: 2, maxSize: 4, speed: 60 },
                            n
                        )),
                    ...
                    (a.initVectors = function() {
                        do
                            (a.vector.x = n.getRandNumber(-a.params.speed / 60,
                                a.params.speed / 60, !1
                            )),
                            (a.vector.y = n.getRandNumber(-a.params.speed / 60,
                                a.params.speed / 60, !1
                            ));
                    ...
                    a.initialize(t, i), { getPosition: a.getPosition, update: a.update, draw: a.draw }
                );
            }),
            a.initialize(t, i), {
                remove: a.remove,
    ...
    (n.getMousePosition = function(t, n) {
        ...
        return (
            ...
            (i = n.getBoundingClientRect()), { x: t.clientX - i.left, y: t.clientY - i.top }
        );
    });
})(jQuery);
/**
...
(function(e) {
    ...
    e.fn.shuffleLetters = function(n) {
        var r = e.extend({ step: 12, fps: 25, text: "", callback: function() {} },
            n
        );
        return this.each(function() {
            var n = e(this),
